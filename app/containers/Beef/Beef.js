...
import BeefPaper from './BeefPaper';
...
export const Beef = React.createClass({
	...
	render() {
		if (this.props.beefData.canBegin === undefined) {
			return (
		...
		if (this.props.beefData.canBegin === false) {
			return (
				<div style={[styles.container, styles.complete]}>
					<NonIdealState
		...
		return (
			<div style={styles.container}>
				...
				{this.state.completedTerms && !this.state.completedReview &&
					<BeefPaper onComplete={this.completeReview} mode={this.state.mode} />
				}

				{this.state.completedTerms && this.state.completedReview && !this.props.beefData.completed &&
					<Survey onComplete={this.completeSurvey} loading={this.state.completedSurvey} />
				}

				{this.props.beefData.completed &&
