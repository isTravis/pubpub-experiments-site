...
export const GraphPresentedVsNotPresented = React.createClass({
	...
	render() {
		...
		return <AnalysisBarChart keys={['Non-Interactive - Found Error', 'Interactive - Found Error', 'Non-Interactive - Found Conclusion', 'Interactive - Found Conclusion']} data={graphData} title={'Performance vs Article Type'} yaxisLabel={'Percent Users'} />;
