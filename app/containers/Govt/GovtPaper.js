		...
		return (
			<div style={styles.container}>
				...
				<div className={'pt-card pt-elevation-2 article-body'} style={styles.paper}>
					<h2 style={styles.header}>Assessing Growth Patterns of the Jurassic Theropod Govtsaur Allosaurus</h2>
					...
					<p style={styles.p}>A total of six femur bones of Allosaurus were selected for this study. These bones came from the Cleveland Lloyd Govtsaur Quarry (CLDQ) in Utah and the Govtsaur Provincial Park (DPP) in Alberta, Canada. Bone lengths and circumferences were measured. We prefer to measure circumference because 1) estimates of circumference based on diameters are underestimates when sections are irregular in shape; 2) circumference is used to predict body mass and 3) circumference is easily comparable across sections of a given bone series. </p>
